          ...
          <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card border-0 shadow rounded-3 my-5">
              <div class="card-body p-4 p-sm-5">
                ...
                <form action="utils/autenticazione.php" method="POST">
                  ...
                  <div class="d-grid">
                    <button class="btn btn-primary btn-login text-uppercase fw-bold" type="submit">Entra</button>
                  </div>
                  <hr class="my-4">
                  
                </form>
                <div class="d-grid mb-2">
                    <a href="register.php" class="btn btn-secondary btn-login text-uppercase fw-bold" >
                       Non ho un account
                    </a>
                  </div>
              </div>
